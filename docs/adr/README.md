...
| [0040](0040-repository-write-interceptors.md)                          | Repository write interceptors (enforced denormalization primitive)                | Accepted                                                      | 2026-08-23 |
| [0041](0041-read-only-query-builder-type.md)                           | Export a read-only query builder type (`ReadOnlyQuery`)                           | Accepted (v3.x, pending merge/release)                        | 2026-08-23 |
| [0042](0042-subclass-schema-argument-assembly.md)                      | Expose `withSchema`'s argument assembly for subclasses                            | Accepted                                                      | 2026-08-23 |
| [0043](0043-write-override-warning.md)                                 | Once-per-class warning when a subclass overrides an unenforceable write method    | Accepted                                                      | 2026-08-24 |
| [0044](0044-typed-pagination-cursor-and-numeric-argument-errors.md)    | Typed pagination-cursor errors and `TypeError` for invalid numeric arguments      | Accepted                                                      | 2026-08-27 |
| [0045](0045-layered-sonarqube-quality-gate.md)                         | Layered SonarQube quality gate (local SonarJS + new-code-only server)             | Accepted (pending merge)                                      | 2026-08-30 |
