...
name: readme-sync
description: >-
  Keep GitHub README.md and npm-readme.md in sync for shared consumer content.
  Use when editing either README, changing install/quick-start examples, peer
  deps, package pitch, migration notes, or docs-site links. NOT for
  contributor-only sections (testing, contributing, ADRs).
---
